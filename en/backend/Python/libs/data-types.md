...
description: "Guide to Python built-in data types including numbers, strings, lists, tuples, dictionaries, and sets with common methods and operations for each type."
icon: "list"
---
