---
title: "MySQL"
description: "MySQL learning notes covering database creation, table management, CRUD operations, multi-table queries, index optimization, and user permissions."
icon: "database"
---
