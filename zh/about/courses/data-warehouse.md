---
title: "数据仓库"
description: "数据仓库课程复习笔记，按老师上课顺序逐章整理各章引言与核心知识，涵盖从传统关系数据库到数据仓库的演进动因与背景、OLTP 联机事务处理与 OLAP 联机分析处理的区别与联系、ETL 数据抽取转换加载流程设计、星型模型与雪花模型维度建模方法以及数据集市概念和多维数据切片钻取操作。"
icon: "warehouse"
---
