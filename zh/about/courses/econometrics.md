---
title: "计量经济学"
description: "计量经济学课程复习笔记，系统梳理 OLS 普通最小二乘法核心原理与正规方程推导过程、一元线性回归模型 RSS 残差平方和最小化、多元线性回归参数估计与显著性检验方法、异方差 White 检验与加权最小二乘修正以及 Durbin-Watson 自相关诊断与 VIF 多重共线性检测。"
icon: "chart-line"
---
