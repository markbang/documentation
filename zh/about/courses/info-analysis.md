---
title: "信息分析"
description: "信息分析课程复习笔记，涵盖专利法核心内容解读、研究设计中调节变量与中介变量的区分方法、概率抽样与非概率抽样、量表 Cronbach α 信度与效度检验、Pearson 相关分析与一元多元线性回归、Logistic 回归模型、探索性因子分析以及 K-Means 聚类与独立样本 t 检验。"
icon: "chart-pie"
---
