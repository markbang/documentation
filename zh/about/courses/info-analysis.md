---
title: "信息分析"
description: "信息分析课程复习笔记，涵盖专利法核心内容与 IPC 国际专利分类、研究设计中调节变量与中介变量的区分、概率与非概率抽样方法、量表信度 Cronbach α 与效度检验、Pearson 相关分析与线性回归、Logistic 回归、探索性因子分析、K-Means 聚类及 t 检验。"
icon: "chart-pie"
---
