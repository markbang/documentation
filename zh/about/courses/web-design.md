---
title: "Web 设计与应用"
description: "Web 设计与应用课程复习笔记，系统涵盖 HTML 超文本标记语言基本结构与常用标签（标题、段落、链接、图片、表格、表单）、CSS 样式选择器优先级计算与盒模型布局方法、JavaScript 基础语法变量函数与 DOM 操作以及响应式设计与 Flex 弹性布局等前端开发核心技术。"
icon: "globe"
---
