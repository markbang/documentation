---
title: "滑动窗口"
description: "滑动窗口算法 LeetCode 刷题笔记，详细讲解左右双指针模板中窗口扩张、条件判断与收缩的完整逻辑流程，包含无重复字符最长子串、最小覆盖子串、字母异位词查找、长度最小子数组与字符串排列等五道经典题目的 Python 解法，并分析每个元素最多被访问两次从而实现 O(n) 时间复杂度的原理。"
