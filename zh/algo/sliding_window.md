---
title: "滑动窗口"
description: "滑动窗口算法是双指针技巧的经典应用，适用于处理数组与字符串的连续子序列问题，本文整理了 left/right 双指针移动的通用 Python 模板代码、窗口扩张与收缩的条件判断逻辑，以及 LeetCode 第 3 题无重复字符最长子串等典型题目的解法与 O(n) 时间复杂度分析。"
