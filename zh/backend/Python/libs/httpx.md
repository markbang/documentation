---
title: "HTTPX"
description: "HTTPX 作为 requests 库的现代化替代方案，是功能完整的新一代 Python HTTP 客户端库，同时支持同步与异步 API 调用以及 HTTP/2 协议传输，本文详解 GET/POST 请求发送用法、超时与重试控制配置、连接池自动复用与客户端长会话管理等核心功能与使用技巧。"
icon: "bolt"
---
