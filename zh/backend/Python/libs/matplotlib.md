---
title: "Matplotlib"
description: "Matplotlib 是 Python 最主流的 2D 绑图库，可生成出版物质量的图形，支持 Python 脚本、IPython Shell 和 Jupyter 等多种运行环境，本文介绍 pyplot 接口的基本用法，涵盖折线图、直方图、条形图与散点图的绑制方法、参数配置与中文字体设置。"
icon: "chart-area"
---
