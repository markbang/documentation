---
title: "Python 学习笔记"
description: "Python 日常学习中积累的编程笔记与实用代码片段合集，内容涵盖 pd.DataFrame 创建格式与 Series 概念、Pandas 文本数据读取与 read_csv 参数配置、describe 描述性统计输出、value_counts 频数分析、交叉表 crosstab 及常见数据处理错误排查方案。"
icon: "note-sticky"
---
